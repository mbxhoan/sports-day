  ...
  return <header className="site-header">
    <div className="header-inner">
      <Link href={prefix || "/"} className="brand" aria-label={t.home}>
        ...
        <span><b>PTSC</b><small>SPORTS FESTIVAL</small></span>
      </Link>
...
export function Footer({ locale, data }: { locale: Locale; data: SiteData }) {
  return <footer className="site-footer">
    ...
    <p>{locale === "vi" ? "Tổng Công Ty Cổ Phần Dịch Vụ Kỹ Thuật Dầu Khí Việt Nam" : "PetroVietnam Technical Services Corporation"}</p>
