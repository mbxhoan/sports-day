...
join (values
  ...
  ('boi-loi','50m-nam-duoi-30','50m tự do nam dưới 30 tuổi','Men’s 50m Freestyle Under 30','Dưới 30 tuổi','Under 30','male','Cá nhân','Individual',1),
  ('boi-loi','50m-nam-31-40','50m tự do nam 31–40 tuổi','Men’s 50m Freestyle 31–40','31–40 tuổi','Ages 31–40','male','Cá nhân','Individual',2),
  ('boi-loi','50m-nam-41-50','50m tự do nam 41–50 tuổi','Men’s 50m Freestyle 41–50','41–50 tuổi','Ages 41–50','male','Cá nhân','Individual',3),
  ('boi-loi','50m-nam-tren-50','50m tự do nam trên 50 tuổi','Men’s 50m Freestyle 50+','Trên 50 tuổi','Ages 50+','male','Cá nhân','Individual',4),
  ('boi-loi','50m-nu-duoi-30','50m tự do nữ dưới 30 tuổi','Women’s 50m Freestyle Under 30','Dưới 30 tuổi','Under 30','female','Cá nhân','Individual',5),
  ('boi-loi','50m-nu-31-40','50m tự do nữ 31–40 tuổi','Women’s 50m Freestyle 31–40','31–40 tuổi','Ages 31–40','female','Cá nhân','Individual',6),
  ('boi-loi','100m-nam-duoi-30','100m tự do nam dưới 30 tuổi','Men’s 100m Freestyle Under 30','Dưới 30 tuổi','Under 30','male','Cá nhân','Individual',7),
  ('boi-loi','100m-nam-41-50','100m tự do nam 41–50 tuổi','Men’s 100m Freestyle 41–50','41–50 tuổi','Ages 41–50','male','Cá nhân','Individual',8),
  ('boi-loi','100m-nu','100m tự do nữ','Women’s 100m Freestyle','Các nhóm tuổi','Age groups','female','Cá nhân','Individual',9),
  ('boi-loi','4x50m-nam','Tiếp sức nam 4×50m','Men’s 4×50m Relay','Đồng đội','Team','male','Tiếp sức','Relay',10),
  ('boi-loi','4x50m-nu','Tiếp sức nữ 4×50m','Women’s 4×50m Relay','Đồng đội','Team','female','Tiếp sức','Relay',11),
...
join (values
  ...
  ('boi-loi','50m-nam-duoi-30','2026-09-05 08:00:00+07'),
  ('boi-loi','50m-nam-31-40','2026-09-05 08:00:00+07'),
  ('boi-loi','50m-nam-41-50','2026-09-05 08:00:00+07'),
  ('boi-loi','50m-nam-tren-50','2026-09-05 08:00:00+07'),
  ('boi-loi','50m-nu-duoi-30','2026-09-05 08:15:00+07'),
  ('boi-loi','50m-nu-31-40','2026-09-05 08:15:00+07'),
  ('boi-loi','100m-nam-duoi-30','2026-09-05 08:15:00+07'),
  ('boi-loi','100m-nam-41-50','2026-09-05 08:15:00+07'),
  ('boi-loi','100m-nu','2026-09-05 08:15:00+07'),
