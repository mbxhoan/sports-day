insert into public.sports (id, slug, name_vi, name_en, emoji, description_vi, description_en, rules_vi, rules_en, sort_order) values
  ('10000000-0000-0000-0000-000000000001', 'pickleball', 'Pickleball', 'Pickleball', '🏓', 'Thi đấu đôi theo nhóm tuổi.', 'Doubles competition by age group.', 'Đang cập nhật', 'Updating', 1),
  ('10000000-0000-0000-0000-000000000002', 'bong-ban', 'Bóng bàn', 'Table Tennis', '🏓', 'Thi đấu đôi nam, đôi nữ và đôi nam nữ.', 'Men’s, women’s and mixed doubles.', 'Đang cập nhật', 'Updating', 2),
  ('10000000-0000-0000-0000-000000000003', 'cau-long', 'Cầu lông', 'Badminton', '🏸', 'Thi đấu đôi theo giới tính và nhóm tuổi.', 'Doubles competition by gender and age group.', 'Đang cập nhật', 'Updating', 3),
  ('10000000-0000-0000-0000-000000000004', 'boi-loi', 'Bơi lội', 'Swimming', '🏊', 'Các cự ly tự do cá nhân và tiếp sức 4×50m.', 'Individual freestyle and 4×50m relays.', 'Đang cập nhật', 'Updating', 4),
  ('10000000-0000-0000-0000-000000000005', 'keo-co', 'Kéo co', 'Tug of War', '🪢', 'Thi đấu đồng đội nam và nữ.', 'Men’s and women’s team competition.', 'Đang cập nhật', 'Updating', 5),
  ('10000000-0000-0000-0000-000000000006', 'dien-kinh', 'Điền kinh', 'Athletics', '🏃', 'Các cự ly 400m, 800m, 3.000m, 5.000m và tiếp sức 4×100m.', '400m, 800m, 3,000m, 5,000m and 4×100m relay events.', 'Đang cập nhật', 'Updating', 6),
  ('10000000-0000-0000-0000-000000000007', 'co-vua', 'Cờ vua', 'Chess', '♟️', 'Hệ Thụy Sĩ cá nhân.', 'Individual Swiss system.', 'Đang cập nhật', 'Updating', 7),
  ('10000000-0000-0000-0000-000000000008', 'co-tuong', 'Cờ tướng', 'Xiangqi', '♜', 'Hệ Thụy Sĩ cá nhân.', 'Individual Swiss system.', 'Đang cập nhật', 'Updating', 8)
