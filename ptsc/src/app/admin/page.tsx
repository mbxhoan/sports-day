...
import { logout, resetPtscResults, saveEvent, saveGalleryDriveUrl, saveManualLeaderboard, saveOrganizationName, saveRecordAction, setArchived, uploadHero } from "./actions";
...
const dashboardColumns = {
  ...
  organizations: "id,code,short_name,name_vi,name_en,logo_path,sort_order,leaderboard_rank,gold_medals,silver_medals,bronze_medals,archived_at",
